...
// =========================================================================
var WidgetMetadata = {
    id: "super_ultimatest_media_hub_max",
    title: "宇宙万能影视终极版",
    description: "二次元全境、全球影剧、全能电影、综艺频道、影剧风向标与平台分流的六合一终极聚合",
    author: "𝙈𝙖𝙠𝙠𝙖𝙋𝙖𝙠𝙠𝙖",
    version: "6.1.0", // 🚀 优化：全球影剧类别右上角菜单改为"影视类型"，"规则排序"移至正常筛选栏
    ...
    modules: [
            ...
            params: [
                {
                    ...
                    enumOptions: [
                        ...
                        { title: "Bilibili 热榜", value: "bili" },
                        { title: "Bangumi 近期热门", value: "hot" },
                        { title: "Bangumi 年度/季度榜单", value: "rank" },
        ...
        // ---------------- 大栏目 2：全球影剧类别 ----------------
        {
            ...
            cacheDuration: 3600,
            params: [
                // 🚀 核心修改：将名称改为 sort_by，触发其前往右上角的菜单！
                ...
                // 🚀 核心修改：将名称改为 order_rule，使其回到普通筛选项中
...
async function loadGenreRank(params = {}) {
    ...
    // 💡 sort_by 现在代表的其实是上方的影视类型 (movie/tv/all)
    const mediaType = params.sort_by || "all"; 
    const genre = params.genre || "all"; 
    const region = params.region || "all"; 
    // 💡 order_rule 是原本的排序方式 (popularity/rating/time)
