WidgetMetadata = {
  id: "danmu_api_Max_color",
  title: "自用弹幕",
  version: "1.0.0", // 并发测试版：基于稳定的1.2.6，仅将请求方式改回并发，测试引擎极限
  ...
  try {
      ...
      if (list.length > 0) {
          ...
          if (colorMode && colorMode !== "none") {
              const COLORS = [
                  16711680, 16776960, 16752384, 16738740, 13445375, 11730943, 16173853, 1439161, 2715135, 16173853, 16736364, 16729975, 3329330, 58624, 3697140, 733833, 16471124, 11730790, 8454687, 12627, 15703326, 1398170 
              ];
